    ...
    const vapiAssistant: CreateAssistantDTO = {
        ...
        model: {
            ...
            messages: [
                {
                    role: "system",
                    content: `You are a highly knowledgeable  teaching a real-time voice session with a student. Your goal is to teach the student about the topic and subject. 
